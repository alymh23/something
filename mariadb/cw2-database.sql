...
--
-- Host: mariadb
-- Generation Time: Dec 15, 2024 at 09:35 PM
...
(2, 644, 507, '2017-11-30', 'Double parkeds', 5),
(3, 13, 21, '2017-09-17', '110mph on motorway', 1),
...
INSERT INTO `log` (`id`, `username`, `reason`, `time`) VALUES
(17, 'daniels', 'Admin logged in', '2024-12-15 21:30:23'),
(18, 'daniels', 'search people', '2024-12-15 21:30:26'),
(19, 'daniels', 'search people', '2024-12-15 21:30:33'),
(20, 'daniels', 'search vehicle', '2024-12-15 21:30:35'),
(21, 'daniels', 'search vehicle', '2024-12-15 21:30:41'),
(22, 'Carter', 'Officer logged in', '2024-12-15 21:30:55'),
(23, 'Carter', 'search people', '2024-12-15 21:30:57'),
(24, 'Carter', 'search people', '2024-12-15 21:31:06'),
(25, 'Carter', 'search vehicle', '2024-12-15 21:31:12'),
(26, 'Carter', 'search vehicle', '2024-12-15 21:31:19'),
(27, 'Carter', 'logout', '2024-12-15 21:31:34');
...
(92, 'Molly Evans', '69 OConnor highway, Hopkinsmouth, IV5E 9PW', 'EVANS55BQNBXK45'),
...
(173, 'Colin OBrien', '768 Stephen drive, Mossstad, TA8 4WX', 'BRI45SWIRVD36'),
...
(384, 'Hayley Jenkins', '27 Katherine shoal, Brientown, S0 8TN', 'JENKI07HCQEYD39'),
...
--
ALTER TABLE `Fines`
  ADD PRIMARY KEY (`Fine_ID`) USING BTREE,
  ADD KEY `fk_fines_incident` (`Incident_ID`) USING BTREE;
...
ALTER TABLE `Incident`
  ...
  ADD KEY `fk_incident_offence` (`Offence_ID`) USING BTREE,
  ADD KEY `fk_incident_people` (`People_ID`) USING BTREE,
  ADD KEY `fk_incident_vehicle` (`Vehicle_ID`) USING BTREE;
...
--
ALTER TABLE `Offence`
  ADD PRIMARY KEY (`Offence_ID`) USING BTREE;
...
ALTER TABLE `Ownership`
  ...
  ADD KEY `fk_ownership_vehicle` (`Vehicle_ID`) USING BTREE;
...
ALTER TABLE `People`
  ...
  ADD UNIQUE KEY `People_licence` (`People_licence`) USING BTREE;
...
ALTER TABLE `Vehicle`
  ...
  ADD UNIQUE KEY `Vehicle_plate` (`Vehicle_plate`) USING BTREE;
